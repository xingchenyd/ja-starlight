export type Job = {
  ...
  responsibilities:string[]; requirements:string[]; benefits:string[]; publishedAt:string; region?:string; sortOrder?:number; featured?:boolean;
};
export type RegistrationField = {id:string;label:string;type:"text"|"tel"|"email"|"textarea";required:boolean};
export type Activity = {id:string;title:string;date:string;place:string;category:string;capacity:number;registered:number;status:string;cover:string;coverType?:"image"|"video";videoUrl?:string;summary:string;registrationFields?:RegistrationField[];region?:string;sortOrder?:number;featured?:boolean};
export type ContentItem = {id:string;title:string;category:string;duration:string;level:string;summary:string;cover:string;coverType?:"image"|"video";mediaType:"article"|"video";sortOrder?:number;featured?:boolean};
