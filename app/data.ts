...
export const jobs: Job[] = [
  {
    ...
    benefits: ["企业导师一对一指导", "真实项目作品沉淀", "星光计划认证成长经历"],
  ...
  },
  {
    ...
    benefits: ["金融业务观察", "项目研究成果", "星光计划认证成长经历"],
  ...
  },
  {
    ...
    benefits: ["公益项目成果", "社会责任实践", "星光计划认证成长经历"],
  ...
  },
  {
    ...
    benefits: ["教育实践经历", "活动执行能力", "星光计划认证成长记录"],
    publishedAt: "2026.08.20",
    region: "湖南",
    sortOrder: 26,
    degree: "高中",
