...
export default function GrowthTimeline({ experiences, loading, error, reload, upload, flash }: {
  ...
  return <section className="growth-timeline-workspace">
    <header><div><small>GROWTH TIMELINE</small><h2>成长时间轴</h2><p>平台活动自动沉淀为星光计划认证经历，也可补充校内项目、比赛和志愿实践。</p></div><button className="primary-btn" onClick={startAdd}>添加经历</button></header>
