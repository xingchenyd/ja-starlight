const allowed = ['AUTH_PEPPER', 'AUTH_SEED_ADMIN_KEY', 'AUTH_SEED_STUDENT_PASSWORD', 'AUTH_SEED_ENTERPRISE_PASSWORD', 'AUTH_TRUSTED_ORIGINS', 'MAIL_PROVIDER', 'RESEND_API_KEY', 'MAIL_FROM', 'MAIL_REPLY_TO', 'TENCENT_SES_REGION', 'TENCENT_SES_SECRET_ID', 'TENCENT_SES_SECRET_KEY', 'TENCENT_SES_TEMPLATE_ID'];
